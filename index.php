  ...
  <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="javascript:al()">Yoga</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="javascript:al()">Gym</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="javascript:al()">Diet</a>
        </li>        
      </ul>
      <form class="form-inline my-2 my-lg-0" action ="signupindex.php">
        <button class="btn btn-outline-success my-3 my-sm-0" type="submit">Sign Up</button>
      </form>
    </div>
  </nav>
  ...
  <section class="background firstsection" id="home">
    <div class="boxmain">
      <div class="fhalf">
        ...
        <div class="buttons">
            <a class="btn btn-success" href="javascript:al()" role="button">Find</a>
        </div>
      </div>
      <div class="shalf">
            ...
            <div class="card mb-4 shadow-sm">
              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <a class="btn btn-lg btn btn-outline-primary" href="javascript:al()" role="button">Click Here</a>
                </div>
              </div>
            </div>
          </div>
